...
desc "Check all AWS Regions for instances"
task :aws_list do
  regions = ["us-east-1", "us-west-1", "eu-west-1", "ap-northeast-1", "ap-southeast-1", "sa-east-1", "us-west-2"]
  regions.each do |region|
    puts "Region: #{region}\n=========================="
    system "ec2-describe-instances --region #{region}"
    puts "==========================\n\n"
  end
end
...
task :aws_list2 do
  ...
  regions.each do |region|
    puts "Region: #{region}\n=========================="
    system "knife ec2 server list --region #{region}"
    puts "==========================\n\n"
  end
end
